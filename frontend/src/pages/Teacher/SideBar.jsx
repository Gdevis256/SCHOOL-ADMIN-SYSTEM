...
const SideBar = () => {
  ...
  const navItems = [
    { to: '/Teacher', label: 'Home', icon: <HomeIcon />, match: ["/Teacher"] },
    { to: '/Teacher/classes', label: 'Classes', icon: <ClassOutlinedIcon />, matchPrefix: '/Teacher/classes' },
    { to: '/Teacher/subjects', label: 'Subjects', icon: <AssignmentIcon />, matchPrefix: '/Teacher/subjects' },
    { to: '/Teacher/teachers', label: 'Teachers', icon: <SupervisorAccountOutlinedIcon />, matchPrefix: '/Teacher/teachers' },
    { to: '/Teacher/students', label: 'Students', icon: <PersonOutlineIcon />, matchPrefix: '/Teacher/students' },
    {
      to: '/Teacher/notices',
      label: 'Notices',
      icon: (
      ...
      matchPrefix: '/Teacher/notices'
    },
     {
      to: '/Teacher/complains',
      label: 'Complaints',
      icon: (
      ...
      matchPrefix: '/Teacher/complains'
    }
  ];

  const userItems = [
    { to: '/Teacher/profile', label: 'Profile', icon: <AccountCircleOutlinedIcon />, matchPrefix: '/Teacher/profile' },
